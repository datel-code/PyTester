REM -----------------------------------------------------------------------
REM --- NeoModelTest Compare Engine PARAMETERS - MAC ----------------------
REM -----------------------------------------------------------------------
...
REM _MAC_OUTFOLDER - MAC Automatic Esko Tester output folder (_PROCESSEDFOLDER + _TOPIC)
REM _HELPERSFOLDER - Path to tester specific helpers

call %G_TIMESTAMP%

echo ^>Entering MAC Parameters_NMTCompare.bat>>%_LOGFILE%
echo ^>Entering MAC Parameters_NMTCompare.bat
