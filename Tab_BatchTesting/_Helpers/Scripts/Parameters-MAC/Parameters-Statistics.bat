...
echo ^>Entering MAC Parameters_Statistics.bat>>%_LOGFILE%
echo ^>Entering MAC Parameters_Statistics.bat
...
REM MAc input override
set _STAT_SOURCEFOLDER=%_MAC_SOURCEFOLDER%
