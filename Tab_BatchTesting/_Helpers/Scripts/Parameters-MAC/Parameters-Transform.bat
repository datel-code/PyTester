...
echo ^>Entering MAC Parameters_Transform.bat>>%_LOGFILE%
echo ^>Entering MAC Parameters_Transform.bat

call %G_GETSAFEDATE% _SAFEDATE

set _TRANSFORM_IN=%_STAT_STATISTICSCOMMONFILE%
set _TRANSFORM_OUT=%_STAT_ROOT%\%_TOPIC%_%_SAFEDATE%-CompareReport.html
