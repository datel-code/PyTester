                                ...
                                <table style="border-spacing: 5px; width: 80vw; border-left: 1px; border-right: 1px; font-size:80%;">
                                    <tbody>
                                        <tr style="background-color: #EBEDEF; border-bottom: 2px">
                                            <th style="text-align: left; width:25%">File/Diff file</th>
                                            <th style="text-align: left; width:10%">Description</th>
                                            <th style="text-align: left; width:10%">How much different now</th>
                                            <th style="text-align: left; width:10%">Last difference</th>
                                            <th style="text-align: left; width:10%">Last check on</th>
                                            <th style="text-align: left; width:30%">Comment</th>
                                            <th style="text-align: left; width:5%">JIRA</th>
                                        </tr>
                                        ...
                                        <xsl:for-each select="$_STAT_TESTREPORTCOMMONFILE_UNC/NMTCompareReport/testqueue[@name=$_THISTASK]/inputfile">
                                            ...
                                            <xsl:if test="./build/@changes = 'true'">
                                                ...
                                                <xsl:variable name="ISSUETYPE"        select="$_STAT_KNOWNISSUESFILE_UNC/KnownIssues/issue[@name=$ISSUENAME]/@type"/>
                                                <xsl:variable name="ISSUEDIFF"        select="$_STAT_KNOWNISSUESFILE_UNC/KnownIssues/issue[@name=$ISSUENAME]/@diff"/>
                                                <xsl:variable name="ISSUECHECKED"     select="$_STAT_KNOWNISSUESFILE_UNC/KnownIssues/issue[@name=$ISSUENAME]/@checked"/>
                                                <xsl:variable name="ISSUECOMMENT"     select="$_STAT_KNOWNISSUESFILE_UNC/KnownIssues/issue[@name=$ISSUENAME]/@comment"/>
                                                ...
                                                <xsl:variable name="ISSUECOLOR">
                                                    <xsl:choose>
                                                        <xsl:when test="$ISSUETYPE = 'IGNORE'">
                                                            <xsl:value-of select="'DarkGray'"/>
                                                        </xsl:when>
                                                        <xsl:when test="$ISSUETYPE = 'NOISE'">
                                                            <xsl:value-of select="'Gray'"/>
                                                        </xsl:when>
                                                        <xsl:when test="$ISSUETYPE = 'KNOWN'">
                                                            <xsl:value-of select="'Green'"/>
                                                        </xsl:when>
                                                        <xsl:when test="$ISSUETYPE = 'TODO'">
                                                            <xsl:value-of select="'Blue'"/>
                                                        </xsl:when>
                                                        <xsl:when test="$ISSUETYPE = 'QA'">
                                                            <xsl:value-of select="'Green'"/>
                                                        </xsl:when>
                                                        <xsl:when test="$ISSUETYPE = 'WATCH'">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <span style="color: {$ISSUECOLOR}; font-weight: {$ISSUESTYLE}">
                                                            <xsl:choose>
                                                    ...
                                                    <td>
                                                        <span style="color: {$ISSUECOLOR}; font-weight: {$ISSUESTYLE}">
                                                            <xsl:value-of select="$ISSUEDIFF"/>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span style="color: {$ISSUECOLOR}; font-weight: {$ISSUESTYLE}">
                                                            <xsl:value-of select="$ISSUECHECKED"/>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span style="color: {$ISSUECOLOR}; font-weight: {$ISSUESTYLE}">
                                                            <xsl:value-of select="$ISSUECOMMENT"/>
                                                        </span>
                                                    </td>
                                                    <td>
                                        ...
                                        <xsl:for-each select="$_STAT_KNOWNISSUESFILE_UNC/KnownIssues/issue[@task=$_THISTASK]">
                                            ...
                                            <xsl:if test="not($KDCOMMENT = '') and not($_STAT_TESTREPORTCOMMONFILE_UNC/NMTCompareReport/testqueue[@name=$_THISTASK]/inputfile[@name=concat($KDNAME,'.tif')])">
