        ...
        <html>
            ...
            <body>
                ...
                <p>
                    ...
                    *) When multipage PDFs are generated, the number of input files and files generated for comparison will always differ!
                </p>
                ...
                <xsl:for-each select="/stat/tasks/task">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Number of input/cfg files:</td> 
                                        ...
                                        <xsl:if test="./build/@changes = 'true'">
                                            ...
                                            <xsl:variable name="ISKPIX" select="contains($DIFFAMOUNT,'Kpix')"></xsl:variable>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <xsl:element name="a">
                                                            <xsl:attribute name="href"><xsl:value-of select="concat($_THISDIFFPATH,'/',$DIFF,'.ontop')"/></xsl:attribute>
