...
REM _TICKETS - a path to Mark sets
...
echo ^>Entering AETLauncher-DM.bat>>%_LOGFILE%
echo ^>Entering AETLauncher-DM.bat
...
if "%_REGIME%" EQU "AUTO" (
        ...
        echo %_jsxUSEIMPORTPDF% %_jsxUSEIMPORTNDLPDF% "%_TICKETS%"
        echo "%_OUTFOLDER%" 
