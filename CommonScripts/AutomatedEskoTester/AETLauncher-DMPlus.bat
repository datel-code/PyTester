...
REM --- Version for Marks Live in PDF+ ------------------------------------
REM -----------------------------------------------------------------------

REM Following variables must be already defined:

REM --- Global variables ---
REM _vbsAET - Launched Visual Basic script
...
echo ^>Entering AETLauncher-DMPlus.bat>>%_LOGFILE%
echo ^>Entering AETLauncher-DMPlus.bat
