...
jobName = WScript.Arguments(10)

jsxArguments = Array(AISignature, testerName, inputFolder, processSubfolder, mask, useImportPDF, useImportNDLPDF, outputFolder, jobName)
