...
outputFolder = WScript.Arguments(7)
jobName = WScript.Arguments(8)
outputType = WScript.Arguments(9)

jsxArguments = Array(AISignature, testerName, inputFolder, processSubfolder, mask, outputFolder, jobName, outputType)
...
'next
ReturnedValue = ""
ReturnedValue = appRef.DoJavaScriptFile(jsxScript, jsxArguments, 1)
'call appRef.DoJavaScriptFile(jsxScript, jsxArguments, 1)

If IsObject(ReturnedValue) Then
    WScript.Echo ReturnedValue
end If
